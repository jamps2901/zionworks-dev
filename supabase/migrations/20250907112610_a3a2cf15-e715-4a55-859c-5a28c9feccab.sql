...
CREATE TABLE public.chat_sessions (
  ...
  customer_name TEXT,
  customer_email TEXT,
  status TEXT NOT NULL DEFAULT 'active' CHECK (status IN ('active', 'closed', 'waiting_for_admin')),
...
-- Create policies for chat sessions (accessible to everyone for now)
...
-- Create policies for chat messages (accessible to everyone for now)
